 ...
 * @author Philip
 */
public class CSVMapExportResultsWindow extends AbstractProcessWindow {
    /**
	 * 
	 */
     ...
     * 
     */
    private CSVJobResultDataExport data;

    /**
     * Creates new form CSVMapExportResultsWindow.
     * @param data 
     */
    public CSVMapExportResultsWindow(final CSVJobResultDataExport data) {
        this.data = data;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        heading.setText("Map Job Results to CSV File");
    ...
    private void nextButtonActionPerformed(final java.awt.event.ActionEvent evt) {
        updateData();
        new CSVViewExportResultsWindow(data).setVisible(true);
        dispose();
    }
    /**
     * 
    ...
    private void backButtonActionPerformed(final java.awt.event.ActionEvent evt) {
        new CSVExportResultsWindow(data).setVisible(true);
        dispose();
    }
    /**
     * 
