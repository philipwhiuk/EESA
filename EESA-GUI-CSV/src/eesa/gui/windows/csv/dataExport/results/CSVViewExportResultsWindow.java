/*
 * CSVViewExportResultsWindow.java
 *
 * Created on 04-Apr-2012, 20:34:52
 */
 ...
 * @author Philip
 */
public class CSVViewExportResultsWindow extends AbstractProcessWindow {
    /**
     * 
     */
    ...
    /** Creates new form CSVViewExportResultsWindow.
     * @param data 
     */
    public CSVViewExportResultsWindow(final CSVJobResultDataExport data) {
        this.data = data;
        initComponents();
    }
    ...
    private void finishButtonActionPerformed(final java.awt.event.ActionEvent evt) {
        try {
            ...
            Logger.getLogger(CSVViewExportResultsWindow.class.getName()).log(Level.SEVERE, null, ex);
