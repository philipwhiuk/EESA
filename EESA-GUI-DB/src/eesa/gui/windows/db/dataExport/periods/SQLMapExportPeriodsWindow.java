 ...
 * To change this template, choose Tools | Templates//GEN-LAST:event_helpButtonActionPerformed
 ...
 * @author Philip
 */
public class SQLMapExportPeriodsWindow extends AbstractProcessWindow {
    /**
	 * 
	 */
    ...
    /**
     * Creates new form SQLMapExportPeriodsWindow.
     * @param data 
     */
    public SQLMapExportPeriodsWindow(final SQLPeriodDataExport data) {
        this.data = data;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        step3.setFont(new java.awt.Font("Tahoma", 2,
        		eesa.gui.Application.STEP_FONT_SIZE)); // NOI18N
        step3.setText("3. Customise Insertion");

        step4.setFont(new java.awt.Font("Tahoma", 1,
        		eesa.gui.Application.STEP_FONT_SIZE)); // NOI18N
        ...
        heading.setText("Map Periods to Database");
    ...
    private void finishButtonActionPerformed(final java.awt.event.ActionEvent evt) {                                             
        ...
        try {            
            ...
            Logger.getLogger(SQLMapExportPeriodsWindow.class.getName()).log(Level.SEVERE, null, ex);
            JOptionPane.showMessageDialog(this, "Mapping Error Occured", "Mapping Error: " + ex.getMessage(), JOptionPane.ERROR_MESSAGE);            
        } catch (DatabaseException ex) {
            Logger.getLogger(SQLMapExportPeriodsWindow.class.getName()).log(Level.SEVERE, null, ex);
            JOptionPane.showMessageDialog(this, "Database Error Occured", "Database Error: " + ex.getMessage(), JOptionPane.ERROR_MESSAGE);            
        } catch (EESAException ex) {
            Logger.getLogger(SQLMapExportPeriodsWindow.class.getName()).log(Level.SEVERE, null, ex);
            JOptionPane.showMessageDialog(this, "Error Occured", "Error: " + ex.getMessage(), JOptionPane.ERROR_MESSAGE);            
        }
    }                                            
     ...
     */
    private void exportData() throws EESAException {
        updateData();
        data.performExport();
    }
    /**
