 ...
 * @author Philip
 */
public class SQLMapExportResultsWindow extends AbstractProcessWindow {
    /**
     * 
     */
     ...
     * 
     */
    private SQLJobResultDataExport data;

    /**
     * Creates new form SQLMapExportResultsWindow.
     * @param data 
     */
    public SQLMapExportResultsWindow(final SQLJobResultDataExport data) {
        this.data = data;
        initComponents();
    }
    /**
    ...
    private void initComponents() {
        ...
        heading.setText("Map Job Results to Database");
    ...
    private void finishButtonActionPerformed(final java.awt.event.ActionEvent evt) {
        try {
            ...
            Logger.getLogger(SQLMapExportResultsWindow.class.getName()).log(Level.SEVERE, null, ex);
