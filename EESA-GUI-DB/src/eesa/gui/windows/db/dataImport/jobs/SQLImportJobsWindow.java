/*
 * SQLImportJobsWindow.java
 *
 * Created on 27-Mar-2012, 01:24:59
 */
 ...
 * @author Philip
 */
public class SQLImportJobsWindow extends AbstractImportJobsWindow {
    /**
     * 
     */
     ...
     * 
     */
    private boolean autoUpdateJDBCField;
    /**
     * 
     */
    private final SQLJobDataImport data;

    /** Creates new form SQLImportJobsWindow.
     * @param data 
     */
    public SQLImportJobsWindow(final SQLJobDataImport data) {
        this.data = data;
        initComponents();
        initListeners();
        HelpManager.addHelpForClassToButton(helpButton, SQLImportJobsWindow.class);
        databaseTypeComboBoxItemStateChanged(null);
        databaseConnectionComboBoxItemStateChanged(null);     
        customConnectionCheckBoxItemStateChanged(null);        
        jdbcCustomiseCheckboxItemStateChanged(null);
    }
    /**
     * 
     */
    ...
    private void initComponents() {
        ...
        jLabel2.setText("5. View Results");
    ...
    private void buildLayout() {
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addComponent(jdbcField, javax.swing.GroupLayout.DEFAULT_SIZE, 255, Short.MAX_VALUE)
                                    .addComponent(usernameField, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 255, Short.MAX_VALUE)
                                    .addComponent(portField, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 255, Short.MAX_VALUE)
                                    .addComponent(hostField, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 255, Short.MAX_VALUE)
                                    .addComponent(passwordField, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 255, Short.MAX_VALUE)
                                    .addComponent(nameField, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 255, Short.MAX_VALUE)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                ...
                                .addGap(34, 34, 34)
                                .addComponent(databaseTypeComboBox, 0, 255, Short.MAX_VALUE))
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                .addComponent(jLabel1)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(customConnectionCheckBox)
                                    .addComponent(databaseConnectionComboBox, 0, 255, Short.MAX_VALUE))))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(connectionCheckLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 7, Short.MAX_VALUE))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(connectionCheckLabel)
                        .addGap(2, 2, 2))
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(hostLabel)
    ...
    private void connectionCheckActionPerformed(final java.awt.event.ActionEvent evt) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, dbConnector.toString() + " Error: " + ex.getMessage(),
            		"Connection Error", JOptionPane.ERROR_MESSAGE);
            Logger.getLogger(SQLImportJobsWindow.class.getName()).log(Level.INFO, "Connection Test Error", ex);
            return;
        }
        JOptionPane.showMessageDialog(this,
        		dbConnector.toString() + " Connection Succesful!", "Connection Success", JOptionPane.INFORMATION_MESSAGE);        
    }
     ...
     * 
     */
    private void updateJDBCConnectionString() {
        if (customConnectionCheckBox.isSelected()) {
