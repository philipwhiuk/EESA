 ...
 * @author Philip
 */
public class XMLMapExportJobsWindow extends AbstractProcessWindow {
    /**
     * 
     */
     ...
     * 
     */
    private XMLJobDataExport data;

    /**
     * Creates new form XMLMapExportJobsWindow.
     * @param data 
     */
    public XMLMapExportJobsWindow(final XMLJobDataExport data) {
        this.data = data;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        heading.setText("Map Jobs to XML");
    ...
    private void nextButtonActionPerformed(final java.awt.event.ActionEvent evt) {
        try {
            ...
            Logger.getLogger(XMLMapExportJobsWindow.class.getName()).log(Level.SEVERE, null, ex);
