/*
 * XMLViewExportJobsWindow.java
 *
 * Created on 04-Apr-2012, 20:22:03
 */
 ...
 * @author Philip
 */
public class XMLViewExportJobsWindow extends AbstractProcessWindow {
    /**
     * 
     */
    ...
    /** Creates new form XMLViewExportJobsWindow.
     * @param data 
     */
    public XMLViewExportJobsWindow(final XMLJobDataExport data) {
        this.data = data;
        initComponents();
        HelpManager.addHelpForClassToButton(helpButton, XMLViewExportJobsWindow.class);
    }
            ...
            .addGroup(stepsPanelLayout.createSequentialGroup()
                ...
                .addGroup(stepsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(stepsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(step1)
                        .addComponent(step3, javax.swing.GroupLayout.DEFAULT_SIZE, 123, Short.MAX_VALUE)
    ...
    private void backButtonActionPerformed(final java.awt.event.ActionEvent evt) {
        new XMLMapExportJobsWindow(data).setVisible(true);
        dispose();
}
    /**
     * 
    ...
    private void finishButtonActionPerformed(final java.awt.event.ActionEvent evt) {
        try {
            ...
            Logger.getLogger(XMLViewExportJobsWindow.class.getName()).log(Level.SEVERE, null, ex);
     ...
     * 
     */
    private void exportData() throws XMLException {
        data.performExport();
    }
}
