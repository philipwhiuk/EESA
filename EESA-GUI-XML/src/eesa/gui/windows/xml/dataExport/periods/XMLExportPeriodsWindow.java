/*
 * XMLExportPeriodsWindow.java
 *
 * Created on 04-Apr-2012, 20:32:00
 */
 ...
 * @author Philip
 */
public class XMLExportPeriodsWindow extends AbstractExportPeriodsWindow {
    /**
     * 
     */
    ...
    /** Creates new form XMLExportPeriodsWindow.
     * @param data 
     */
    public XMLExportPeriodsWindow(final XMLPeriodDataExport data) {
        this.data = data;
        initComponents();
    }
    ...
    private void nextButtonActionPerformed(final java.awt.event.ActionEvent evt) {
        updateData();
        try {
            new XMLOutputExportPeriodsWindow(data).setVisible(true);
            dispose();
        } catch (IOException ex) {
            Logger.getLogger(XMLExportPeriodsWindow.class.getName()).log(Level.SEVERE, null, ex);
