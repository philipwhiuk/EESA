 ...
 * @author Philip
 */
public class XMLMapExportResultsWindow extends javax.swing.JFrame {
    /**
	 * 
	 */
    ...
    /**
     * Creates new form XMLMapExportResultsWindow.
     * @param data 
     */
    public XMLMapExportResultsWindow(final XMLJobResultDataExport data) {
        this.data = data;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        heading.setText("Map Job Results to XML");
    ...
    private void nextButtonActionPerformed(final java.awt.event.ActionEvent evt) {
        try {
            updateData();
            new XMLViewExportResultsWindow(data).setVisible(true);
            dispose();
        } catch (InvalidMappingException ex) {
            Logger.getLogger(XMLMapExportResultsWindow.class.getName()).log(Level.SEVERE, null, ex);
