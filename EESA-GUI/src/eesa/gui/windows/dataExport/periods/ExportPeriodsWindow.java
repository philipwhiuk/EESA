/*
 * ExportPeriodsWindow.java
 *
 * Created on 04-Apr-2012, 20:30:02
 */
...
/**
 * Provides exporter selection of periods.
 * @author Philip
 */
public class ExportPeriodsWindow extends AbstractExportPeriodsWindow {
    /**
     * 
     */
     ...
     * 
     */
    private PeriodDataExport data;
    /**
     * 
     */
    private ArrayList<PluginConnector> validConnectors;

    /** Creates new form ExportPeriodsWindow. */
    public ExportPeriodsWindow() {
        getValidConnectors();
        initComponents();
        HelpManager.addHelpForClassToButton(helpButton, ExportPeriodsWindow.class);
    }
    /**
     * 
     * @param data 
     */
    public ExportPeriodsWindow(final PeriodDataExport data) {
        this();
        this.data = data;
        setInitialSelection();
    }
    ...
    private void nextButtonActionPerformed(final ActionEvent evt) {
        ...
        if (data != null & data.getClass().equals(plugin.getClass())) {
            plugin.getNewExportPeriodsWindow(data).setVisible(true);
            dispose();
        } else {
    ...
    private void getValidConnectors() {
        ...
        for (int c = 0; c < connectors.length; c++) {
            if (connectors[c].hasPeriodDataExportClass()) {
