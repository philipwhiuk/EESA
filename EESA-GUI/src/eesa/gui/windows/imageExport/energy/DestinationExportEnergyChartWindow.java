...
/**
 * Allows the user to select the destination of the energy chart image.
 * @author Philip
 */
public class DestinationExportEnergyChartWindow extends AbstractProcessWindow {
    /**
     * 
     */
    ...
    /**
     * Creates new form DestinationExportEnergyChartWindow.
     * @param data 
     */
    public DestinationExportEnergyChartWindow(final EnergyImageExport data) {
        this.data = data;
        initComponents();
    }
    ...
    private void nextButtonActionPerformed(final ActionEvent evt) {
        updateData();
        new OutputExportEnergyChartWindow(data).setVisible(true);
    }
    /**
     * 
     * @param evt
