/*
 * ExportEnergyChartWindow.java
 *
 * Created on 06-Apr-2012, 22:12:22
 */
 ...
 * @author Philip
 */
public class ExportEnergyChartWindow extends AbstractProcessWindow {
    /**
	 * 
	 */
	 ...
	 * 
	 */
	private EnergyImageExport data;
    /**
     * 
     */
    ...
    public ExportEnergyChartWindow() {
        initComponents();
    }
    /**
     * 
     * @param data
     */
    public ExportEnergyChartWindow(final EnergyImageExport data) {
        this();
        this.data = data;
        setInitialSelection();
    }    
    ...
    private void initComponents() {
        ...
        processorLabel.setFont(new java.awt.Font("Tahoma", 1, eesa.gui.Application.FONT_SIZE)); // NOI18N
    ...
    private void nextButtonActionPerformed(final ActionEvent evt) {
        updateData();
        new SplitExportEnergyChartWindow(data).setVisible(true);
    }
    /**
     * 
     * @param evt Event
