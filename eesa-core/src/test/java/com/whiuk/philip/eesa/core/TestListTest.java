...
public class TestListTest {
	...
	public final void testAddTestByTest() {
        ...
        com.whiuk.philip.eesa.core.Test test = null;
        TestList instance = new TestList();
	...
	public final void testGetTest() {
        ...
        com.whiuk.philip.eesa.core.Test result = instance.getTest(i);
        assertEquals(expResult, result);
    }
	...
	public final void testRemoveTestInt() {
        ...
        int index = 0;
        TestList instance = new TestList();
        instance.addTest(new com.whiuk.philip.eesa.core.Test());
	...
	public final void testGetTestByID() {
        ...
        int id = 0;
        TestList instance = new TestList();
        com.whiuk.philip.eesa.core.Test expResult = null;
        com.whiuk.philip.eesa.core.Test result = instance.getTestByID(id);
        assertEquals(expResult, result);
    }
	...
	public final void testRemoveTest() {
        System.out.println("removeTest");
        com.whiuk.philip.eesa.core.Test t = null;
        TestList instance = new TestList();
